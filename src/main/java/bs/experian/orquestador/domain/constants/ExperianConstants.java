...
public final class ExperianConstants {
   ...
   //tipo de estados documento 
    ...
    public static final Set<String> ESTADOS_FINALES_DOCUMENTACION = Set.of(
    			SUBSTATUS_ALL_DOCUMENTS_DOWNLOADED,
    			SUBSTATUS_PARTIAL_DOCUMENTS_DOWNLOADED
    		);
